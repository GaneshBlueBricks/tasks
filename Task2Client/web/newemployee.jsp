<%-- 
    ...
    Created on : 26 Jun, 2023, 7:51:34 PM
    Author     : Ganesh
--%>
...
<html>
    ...
    <body>
        <!--http://localhost:8080/Task2/webresources/ControllerClass/createEmployee-->
        <form id="formdata" >
           ...
           const resultDiv = document.getElementById('resultfromback');
            form.addEventListener('submit', function (event) {
              ...
              console.log(jsonString); // '{"name":"John","email":"john@example.com","age":"30"}'
               ...
               fetch('http://localhost:8080/Task2/webresources/ControllerClass/createEmployee', {
                method: 'POST',
                headers: {
